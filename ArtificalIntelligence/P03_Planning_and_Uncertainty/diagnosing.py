...
p1 = model.predict_proba({'PatientAge':'31-65'})[1].parameters[0]["Ischemic Stroke"] * model.predict_proba({'PatientAge':'31-65','CTScanResult':"Ischemic Stroke"})[5].parameters[0]["True"]
print(p1)

print("p2 = P(Disability='Moderate' && CTScanResult='Hemmorraghic Stroke' | PatientAge='65+' &&  MRIScanResult='Hemmorraghic Stroke')")
p2 = model.predict_proba({'PatientAge':'65+','MRIScanResult':'Hemmorraghic Stroke'})[1].parameters[0]["Hemmorraghic Stroke"] * model.predict_proba({'PatientAge':'65+','MRIScanResult':'Hemmorraghic Stroke','CTScanResult':"Hemmorraghic Stroke"})[6].parameters[0]["Moderate"]
print(p2)

print("p3 = P(StrokeType='Hemmorraghic Stroke' | PatientAge='65+' && CTScanResult='Hemmorraghic Stroke' && MRIScanResult='Ischemic Stroke')")
p3 = model.predict_proba({'PatientAge':'65+','CTScanResult':'Hemmorraghic Stroke','MRIScanResult':'Ischemic Stroke'})[3].parameters[0]["Hemmorraghic Stroke"]
print(p3)

print("p4 = P(Anticoagulants='Used' | PatientAge='31-65')")
p4 = model.predict_proba({'PatientAge':'31-65'})[4].parameters[0]["Used"]
print(p4)

print("p5 = P(Disability='Negligible')")
p5 = model.predict_proba({})[6].parameters[0]["Negligible"]
print(p5)